...
### Config with Exclusions and Per-Project Overrides
...
export default defineConfig({
  ...
  projects: {
    frontend: { docsSubfolder: 'documentation' },
  },
});
```
...
**Creates (using defaults, or your answers if run in a terminal):**
```
my-new-docs/
...
# Discover as machine-readable JSON
